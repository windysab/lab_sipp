		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"><i class="fas fa-user-friends mr-2"></i> Usia Pihak Tergugat/Termohon</h1>
						</div>
						<div class="col-sm-6">
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card card-primary card-outline">
						...
						<div class="card-body">
							<form action="<?php echo base_url() ?>index.php/usia_pihak_t" method="POST" class="form-horizontal">
						...
						<div class="card">
							<div class="card-header bg-success">
								<h3 class="card-title">
									...
									Data Usia Pihak Tergugat/Termohon
								</h3>
