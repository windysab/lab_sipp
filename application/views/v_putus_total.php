		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"><i class="fas fa-gavel mr-2"></i> Laporan Perkara Putus Total</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="<?= site_url('Admin/Dashboard') ?>">Home</a></li>
								<li class="breadcrumb-item">Perkara</li>
								<li class="breadcrumb-item active">Perkara Putus Total</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<section class="content">
				<div class="container-fluid">
					...
					<div class="card card-primary card-outline">
						...
						<div class="card-body">
							<form action="<?php echo base_url() ?>index.php/Putus_total" method="POST" class="form-horizontal">
								...
								<div class="form-group row">
									<div class="col-sm-10 offset-sm-2">
										...
										<?php if (!empty($datafilter)): ?>
											<a href="<?= base_url('index.php/Putus_total/export_excel/' .
					...
					<?php if (!empty($datafilter)): ?>
						<div class="card card-outline card-primary">
							<div class="card-header">
								<h3 class="card-title"><i class="fas fa-table mr-1"></i> Data Perkara Putus Total <?php echo (isset($_POST['lap_bulan']) && isset($months[$_POST['lap_bulan']])) ? $months[$_POST['lap_bulan']] . ' ' . $_POST['lap_tahun'] : ''; ?></h3>
								<div class="card-tools">
									<button type="button" class="btn btn-tool" data-card-widget="collapse">
										<i class="fas fa-minus"></i>
									</button>
									...
									<tbody>
										...
										foreach ($datafilter as $row): ?>
											<tr>
												...
												<td class="text-center">
													<span class="badge badge-<?= $row->putus > 10 ? 'danger' : ($row->putus > 5 ? 'warning' : 'success') ?> badge-pill"><?= $row->putus ?></span>
												</td>
												<td class="text-center">
													<?php
													// Fix division by zero error
													if (isset($stats->total_perkara) && $stats->total_perkara > 0) {
														$percentage = ($row->putus / $stats->total_perkara) * 100;
												...
												<td>
													<a href="<?= site_url('Putus_total/detail/' . str_replace(',', '-', $row->majelis_hakim_id)) ?>" class="btn btn-sm btn-info" data-toggle="tooltip" title="Lihat Detail Perkara">
													...
													<div class="btn-group">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="<?= site_url('Putus_total/export_detail/' . str_replace(',', '-', $row->majelis_hakim_id)) ?>">
					...
					<?php else: ?>
						...
						<div class="alert alert-info">
							...
							<p>Silakan pilih periode dan jenis perkara untuk melihat data perkara putus total.</p>
