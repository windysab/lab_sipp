...
<head>
	...
	<title>BHT Perkara Putus 2 | SIPP</title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"><i class="fas fa-file-contract mr-2"></i> BHT Perkara Putus 2</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="<?= site_url('home') ?>">Home</a></li>
								<li class="breadcrumb-item active">BHT Perkara Putus 2</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<section class="content">
				<div class="container-fluid">
					...
					<div class="card card-primary card-outline">
						...
						<div class="card-body">
							<form action="<?php echo base_url() ?>index.php/Bht_putus_2" method="POST" class="form-horizontal">
					...
					<div class="row">
						<div class="col-12">
							<div class="card card-outline card-primary">
								<div class="card-header">
									<h3 class="card-title">
										<i class="fas fa-table mr-1"></i> Detail BHT Perkara Putus 2
								...
								<div class="card-body">
									<?php if (!empty($bht_putus)): ?>
										<div class="table-responsive">
											<table id="bhtTable2" class="table table-bordered table-striped table-hover">
												<thead>
													<tr>
												...
												<tbody>
														...
														if ($row->pbt && $row->pbt != '') {
															...
															foreach ($pbt_dates as $date) {
																if ($date && $date != '') {
																	...
																	$pbt_html .= '<span class="date-item">' . $formatted_date . '</span>';
																}
															}
															$pbt = !empty($formatted_dates) ? implode('<br>', $formatted_dates) : 'Tidak';
														} else {
															$pbt = 'Tidak';
														}
													...
													?>
														<tr>
															...
															<td class="text-center multiple-dates">
																<?php if ($pbt && $pbt != 'Tidak'): ?>
																	<div class="text-success"><?= $pbt_html ?: $pbt ?></div>
																<?php else: ?>
		...
		$(function() {
			...
			$("#bhtTable2").DataTable({
				...
				"buttons": [{
						...
						title: 'BHT Perkara Putus 2 <?= isset($months) ? $months[$lap_bulan] : '' ?> <?= $lap_tahun ?>'
					},
					{
						extend: 'pdf',
